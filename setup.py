...
URL = "https://github.com/andlo/ovos-skill-geography"
SKILL_CLAZZ = "Geography"
PYPI_NAME = "ovos-skill-geography"
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Geography facts for OVOS - capitals, continents, borders, area, currency, and language for 194 UN member states, fully offline",
    ...
    keywords="ovos skill voice assistant geography countries capitals reference",
